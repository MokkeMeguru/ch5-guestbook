...
var or__28643__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__28643__auto__)){
return or__28643__auto__;
} else {
var or__28643__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__28643__auto____$1)){
return or__28643__auto____$1;
} else {
var or__28643__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__28643__auto____$2)){
return or__28643__auto____$2;
} else {
var or__28643__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__28643__auto____$3)){
return or__28643__auto____$3;
} else {
...
var n__30147__auto__ = a.length;
var i = (0);
while(true){
if((i < n__30147__auto__)){
var c_34292 = (a[i]);
if(cljs.core.truth_((c_34292["cljsIsDirty"]))){
(c_34292["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__29690__auto__,writer__29691__auto__,opt__29692__auto__){
return cljs.core._write.call(null,writer__29691__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__34296 = c;
var G__34296__$1 = (((G__34296 == null))?null:(G__34296["props"]));
if((G__34296__$1 == null)){
return null;
} else {
return (G__34296__$1["argv"]);
}
});
...
var G__34298_34299 = (c["cljsRatom"]);
if((G__34298_34299 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__34298_34299);
}
