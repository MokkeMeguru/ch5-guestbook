...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__29690__auto__,writer__29691__auto__,opt__29692__auto__){
return cljs.core._write.call(null,writer__29691__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__28643__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__28643__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__28643__auto__)){
return or__28643__auto__;
} else {
...
var G__34303 = o;
(G__34303[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__34304__delegate = function (args){
...
while (G__34305__i < G__34305__a.length) {G__34305__a[G__34305__i] = arguments[G__34305__i + 0]; ++G__34305__i;}
  args = new cljs.core.IndexedSeq(G__34305__a,0);
} 
return G__34304__delegate.call(this,args);};
G__34304.cljs$lang$maxFixedArity = 0;
G__34304.cljs$lang$applyTo = (function (arglist__34306){
var args = cljs.core.seq(arglist__34306);
return G__34304__delegate(args);
});
...
var old_34307 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_34307))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_34307)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__28631__auto__ = (node === document.activeElement);
if(and__28631__auto__){
var and__28631__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
if(cljs.core.truth_(and__28631__auto____$1)){
...
if(cljs.core.truth_((function (){var and__28631__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__34310 = jsprops;
(G__34310["defaultValue"] = value);

(G__34310["onChange"] = ((function (G__34310,v,value,on_change){
return (function (p1__34308_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__34308_SHARP_);
});})(G__34310,v,value,on_change))
);
...
var vec__34312 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__34312,(0),null);
var id = cljs.core.nth.call(null,vec__34312,(1),null);
var class$ = cljs.core.nth.call(null,vec__34312,(2),null);
...
var temp__4659__auto__ = (function (){var G__34316 = cljs.core.meta.call(null,v);
if((G__34316 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__34316);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__34318_34319 = v;
var G__34318_34320__$1 = (((G__34318_34319 == null))?null:reagent.impl.template.key_from_vec.call(null,G__34318_34319));
if((G__34318_34320__$1 == null)){
} else {
(jsprops["key"] = G__34318_34320__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__34323 = cljs.core.meta.call(null,argv);
if((G__34323 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__34323);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__34324 = (((jsprops == null))?{}:jsprops);
(G__34324["key"] = key);
...
var G__34325 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__34325;
continue;
}
} else {
...
var n__30147__auto___34326 = a.length;
var i_34327 = (0);
while(true){
if((i_34327 < n__30147__auto___34326)){
(a[i_34327] = reagent.impl.template.as_element.call(null,(a[i_34327])));
...
var a = cljs.core.into_array.call(null,s);
var n__30147__auto___34329 = a.length;
var i_34330 = (0);
while(true){
if((i_34330 < n__30147__auto___34329)){
var val_34331 = (a[i_34330]);
if((cljs.core.vector_QMARK_.call(null,val_34331)) && ((reagent.impl.template.key_from_vec.call(null,val_34331) == null))){
(o["no-key"] = true);
} else {
}

(a[i_34330] = reagent.impl.template.as_element.call(null,val_34331));

var G__34332 = (i_34330 + (1));
i_34330 = G__34332;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__28631__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__28631__auto__){
return (ctx["no-key"]);
} else {
return and__28631__auto__;
...
var G__34334 = (cljs.core.count.call(null,argv) - first_child);
switch (G__34334) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__34334){
